...
// Admin password hash loaded from environment variable (Base64 encoded to avoid $ issues)
// To generate: node -e "console.log(Buffer.from(require('bcryptjs').hashSync('your_password', 12)).toString('base64'))"
const ADMIN_PASSWORD_HASH_B64 = process.env.ADMIN_PASSWORD_HASH_B64;
const ADMIN_PASSWORD_HASH = ADMIN_PASSWORD_HASH_B64 ? Buffer.from(ADMIN_PASSWORD_HASH_B64, 'base64').toString('utf8') : null;
